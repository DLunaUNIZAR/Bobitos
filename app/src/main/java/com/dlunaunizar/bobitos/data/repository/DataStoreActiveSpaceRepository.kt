...
@Singleton
class DataStoreActiveSpaceRepository @Inject constructor(@param:ApplicationContext private val context: Context) :
    ActiveSpaceRepository {
    override fun activeSpaceId(userId: String): Flow<String?> = context.activeSpaceDataStore.data.map { preferences ->
    ...
    private fun preferenceKey(userId: String) = stringPreferencesKey("active_space_$userId")
}
